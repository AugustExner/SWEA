...
class UpdateTool extends NullTool {
  ...
  public void mouseDown(MouseEvent e, int x, int y) {
    ...
    case 5: {
      ...
      case 6:
        editor.showStatus("State change: Inspect city at (1,0)");
        game.setTileFocus(new Position(1,0));
        break;
     case 7:
        editor.showStatus("State change: Inspect plain at (12,12)");
        game.setTileFocus(new Position(12,12));
